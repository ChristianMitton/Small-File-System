...
//for dev_read, void *buf = where you want the data you're reading to be stored
//for dev_write, void *buf = block of data you want to write to the specified block in the disk(file)
